...
public class UserService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        if (usuario==null)
        {
            logger.error("Error en la autentificacion: no existe el suaurio '"+email+"' en el sistema.");
        ...
        return new User(usuario.getEmail(), usuario.getPassword(), usuario.getEstActivo(), true,
